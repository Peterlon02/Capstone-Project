...
useEffect(()=>{
  const fetchArticoli =async()=>{
    try{
      const response= await axios.get(`https://capstone-project-alpha-gilt.vercel.app/api/highlights`)
...
useEffect(()=>{
  const fetchArticoli =async()=>{
    try{
      const response= await axios.get(`https://capstone-project-alpha-gilt.vercel.app/api/articoli-pallavolo/Volleyball`)
