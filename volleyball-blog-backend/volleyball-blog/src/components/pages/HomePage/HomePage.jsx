...
useEffect(()=>{
  const fetchArticoli =async()=>{
    try{
      const response= await axios.get(`${process.env.REACT_APP_API_URL}/api/highlights`)
...
useEffect(()=>{
  const fetchArticoli =async()=>{
    try{
      const response= await axios.get(`${process.env.REACT_APP_API_URL}/api/articoli-pallavolo/Volleyball`)
